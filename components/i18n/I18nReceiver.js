...
export default class I18nReceiver extends Component {
  ...
  recieve() {
    ...
    const { happyOptimismI18n } = this.context;
    const i18n = (happyOptimismI18n && happyOptimismI18n[componentName]) || {};
    return {
      ...(typeof defaultI18n === 'function' ? defaultI18n() : defaultI18n),
      ...(typeof i18n === 'function' ? i18n() : i18n),
      mark: (happyOptimismI18n && happyOptimismI18n.mark) || 'zh-CN', // i18n标记
    };
  }
