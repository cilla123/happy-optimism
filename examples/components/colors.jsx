...
import { H2, H4 } from './markdown/heading';
...
export default function Colors(props) {
  ...
  return (
    <div className="happy-optimism-react-container">
      <section className="happy-optimism-react-markdown">
        <H2>{title}</H2>
        {desc}

        <H4>{palettes.primary.title}</H4>
        {palettes.primary.desc}
        <div className="happy-optimism-react-color-row">
        ...
        <div className="happy-optimism-react-color-row">
          <ColorCell
            className="happy-optimism-react-color-cell__mask-white"
...
function ColorCell({ color, name, light, className }) {
  return (
    <div
      className={cx('happy-optimism-react-color-cell', className, {
        'happy-optimism-react-color-cell--light': light,
        'happy-optimism-react-color-cell--dark': !light,
      })}
      style={{ background: color }}
    >
      <div className="happy-optimism-react-color-cell__name">{name}</div>
      <div className="happy-optimism-react-color-cell__color">{color}</div>
    </div>
  );
}
